...
seed = 42
n_val = 10                         # num validatino samples
...
tts_schedule = [(10,  1e-3,  60_000,  32),   # progressive training schedule
                (5,  1e-4, 120_000,  16),   # (r, lr, step, batch_size)
                (2,  1e-4, 180_000,  8),
                (1,  1e-4, 300_000,  8)]
...
forward_schedule = [(1e-4, 10_000,  32),    # progressive training schedule
                    ...
                    (2e-5, 700_000,  32)]   # (lr, step, batch_size)
